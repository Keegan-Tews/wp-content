...
<head>
  ...
  <meta name="description" content="Fictional University is a modern and responsive WordPress theme by Keegan Tews.">
    <?php wp_head(); ?>
      ...
      <div class="container">
        ...
        <div class="site-header__menu group">
          ...
          <div class="site-header__util">
            ...
            <a href="#" class="btn btn--small btn--dark-orange float-left push-right">Sign Up</a>
